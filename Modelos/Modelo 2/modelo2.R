...
error_cuadratico_medio <- mean((accidentes$Indice_Accidentalidad - predicciones_rf)^2)
...
# PRECISION
# Convertir las predicciones en clasificación binaria
predicciones_binarias_prec <- ifelse(predicciones_rf > umbral_prec, 1, 0)
...
# RECALL
# Convertir las predicciones en clasificación binaria
predicciones_binarias_recall <- ifelse(predicciones_rf > umbral, 1, 0)
...
# Convertir las predicciones en clasificación binaria
predicciones_binarias_mc <- ifelse(predicciones_rf > umbral, 1, 0)
